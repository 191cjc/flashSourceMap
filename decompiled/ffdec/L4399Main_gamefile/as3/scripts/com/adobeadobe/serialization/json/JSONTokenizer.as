package com.adobeadobe.serialization.json
{
   public class JSONTokenizer
   {
      ...
      public function unescapeString(param1:String) : String
      {
         ...
         if(Boolean(this.strict) && Boolean(this.controlCharsRegExp.test(param1)))
         {
      ...
      {
         return Boolean(this.isDigit(param1)) || param1 >= "A" && param1 <= "F" || param1 >= "a" && param1 <= "f";
      }
