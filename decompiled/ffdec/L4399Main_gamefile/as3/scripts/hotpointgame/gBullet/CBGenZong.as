package hotpointgame.gBullet
{
   ...
   public class CBGenZong extends ZtB
   {
      ...
      public function CBGenZong(param1:MovieClip, param2:ZhangDouT, param3:Object, param4:ZhangDouT, param5:int = 0)
      {
         this.targetZt = param4;
      ...
      override protected function dataInit(param1:Object) : void
      {
         ...
         this.onlyt = param1.others.onlyt;
         ...
         if(runState == 0 && bSpeed != 0)
         {
            ...
            while(_loc4_ > 0)
            {
               ...
               if(_loc14_ == 0)
               {
                  ...
                  else if(this.targetZt.bhitTestByPoint(_loc10_,_loc11_))
                  {
                     _loc14_ = 2;
                  }
               }
            ...
            if(bSpeed != 0)
            {
               ...
               else if(this.targetZt.bhitTestByObject(getAhit()))
               {
                  this.enterRunStataOne();
                  return;
               }
