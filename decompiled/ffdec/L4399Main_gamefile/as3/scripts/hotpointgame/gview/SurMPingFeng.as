package hotpointgame.gview
{
   ...
   public class SurMPingFeng
   {
      
      public static var self:SurMPingFeng = new SurMPingFeng();
      ...
      public function reset() : void
      {
         ...
         if(this.mc == null)
         {
            if(!LoaderManager.isLoadedBySwfname("map_0_8"))
            {
            ...
            _loc2_ = LoaderManager.getSwfClass("ylgdcjl") as Class;
