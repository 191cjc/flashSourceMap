package hotpointgame.gview
{
   ...
   public class NpcGuiStong
   {
      
      private static var self:NpcGuiStong = new NpcGuiStong();
      
      private static var curs:int = 0;
      
      private var mc:MovieClip;
      
      public function NpcGuiStong()
      {
         super();
      }
      ...
      {
         var _loc1_:Class = LoaderManager.getSwfClass("yindao2") as Class;
      ...
      private function clickH(param1:MouseEvent) : void
      {
         ...
         {
            _loc2_ = int(param1.target.name.substr(1));
            if(_loc2_ == 10)
            {
               this.leave();
            }
