package hotpointgame.grole
{
   ...
   public class CplayerManGun extends CPlayer
   {
      ...
      public function CplayerManGun(param1:MPlayer)
      {
         super();
         ztGroup = GS.a1;
         ztType = GS.a1;
      ...
      {
         actionObj["技能" + param1] = RoleActionManger.getRActionByName("技能" + param1 + param2);
      }
      
      override public function skillUpByWuXin(param1:int, param2:String, param3:int) : void
      {
         actionObj["阶段" + param1] = RoleActionManger.getRActionByName("" + param2 + param3);
      }
      ...
      private function actionInit(param1:Array) : void
      {
         ...
         var _loc2_:Array = ["倒地","被打","冰冻","眩晕","水泡","束缚","石化","死亡","待机","跑","走","起身","跳","攻击","普通武器跳击","跑攻","跳冲"];
         var _loc3_:Object = {};
         for each(_loc4_ in _loc2_)
         {
            actionObj[_loc4_] = RoleActionManger.getRActionByName(_loc4_ + 1);
         }
         _loc5_ = int(GS.a1);
         while(_loc5_ < GS.a8)
         {
            ...
            {
               actionObj["技能" + _loc5_] = RoleActionManger.getRActionByName("技能" + _loc5_ + param1[_loc5_ - GS.a1]);
         ...
         while(_loc6_ < GS.a5)
         {
            ...
            if(_loc7_[0] > 0)
            {
               actionObj["阶段" + _loc6_] = RoleActionManger.getRActionByName("" + _loc7_[2] + _loc7_[1]);
      ...
      override public function changePowerAndForth(param1:int = 0) : void
      {
         ...
         if(param1 == 1)
         {
            if(_forth != -1)
            {
               GM.onlineM.fRoleMove(this.getZx(),this.getZy(),-1,"仅方向",this.mp.getRoleSpeed());
            }
            this.setForth(-1);
      ...
      override public function switchJiJia() : void
      {
         ...
         var _loc1_:Class = LoaderManager.getSwfClass("JijiaAgmzxbsxg") as Class;
      ...
      override public function switchRenr() : void
      {
         ...
         this.currentState = -GS.a1;
         this.jijiachangestate = GS.a1;
         var _loc1_:Class = LoaderManager.getSwfClass("JijiaAgmzjbhr") as Class;
         var _loc2_:MovieClip = new _loc1_();
         var _loc3_:Point = Pos.l_To_G(this.getZmc());
         _loc2_.x = _loc3_.x;
         _loc2_.y = _loc3_.y;
      ...
      override public function getCplayerJiJIaState() : Number
      {
         ...
         if(this.playdoing is PlayerDoP)
         {
            return GS.a0;
         }
         if(this.playdoing is PlayerDoJA)
         {
            return GS.a1;
         }
         return GS.a2;
      ...
      override public function getFightSocre() : Number
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * (GS.a85 + GS.a02);
         }
         _loc2_ = null;
         _loc2_ = actionObj["技能" + GS.a2];
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * GS.a80;
         }
         _loc2_ = null;
         _loc2_ = actionObj["技能" + GS.a3];
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * GS.a46;
         }
         _loc2_ = null;
         _loc2_ = actionObj["技能" + GS.a4];
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * (GS.a8 + GS.a03);
         }
         _loc2_ = null;
         _loc2_ = actionObj["技能" + GS.a5];
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * (GS.a52 + GS.a08);
         }
         _loc2_ = null;
         _loc2_ = actionObj["技能" + GS.a6];
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * GS.a60;
         }
         _loc2_ = null;
         _loc2_ = actionObj["技能" + GS.a7];
         if(_loc2_ != null)
         {
            _loc1_ += _loc2_.getFd().shangHaiBi * (GS.a4 + GS.a08);
         }
         return (GS.a38 + GS.a04 + _loc1_ * (GS.a05 / GS.a10 + GS.a06)) / GS.a60;
      }
