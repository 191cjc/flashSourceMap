package hotpointgame.grole
{
   ...
   public class PlayerDoJA extends PlayerDo
   {
      ...
      public function PlayerDoJA()
      {
         super();
         var _loc1_:Class = LoaderManager.getSwfClass("JijiaA_guangmingzhixing") as Class;
      ...
      override public function gmUpdate(param1:CPlayer) : void
      {
         ...
         if(this.jinengFiveFlag)
         {
            if(GM.frameTime - this.jinengFourFlag > GS.a60)
            {
               this.jinengFiveFlag = false;
               (this.jaAtionObj["技能" + GS.a4] as CAction).setccd(GM.frameTime - (GS.a100 * GS.a3 + GS.a28));
            }
         }
         var _loc2_:int = 1;
         while(_loc2_ <= 4)
      ...
      private function actionInit() : void
      {
         ...
         Czhujiemian.self.skillTiaoInitByJiJia(0,41);
         Czhujiemian.self.skillTiaoInitByJiJia(1,42);
         Czhujiemian.self.skillTiaoInitByJiJia(2,43);
         Czhujiemian.self.skillTiaoInitByJiJia(3,44);
      }
      ...
      private function keyControl(param1:CPlayer) : void
      {
         ...
         if(Boolean(GM.ckey.isKey("机甲技能" + GS.a4)) && Boolean(this.skillIsKeUser(param1,"技能" + GS.a4)))
         {
            if(this.jinengFiveFlag)
            {
               _loc3_ = "技能" + GS.a5;
               this.changeActionByNameAndUpdate(param1,_loc3_);
               (this.jaAtionObj["技能" + GS.a4] as CAction).setccd(GM.frameTime);
               this.jinengFiveFlag = false;
            }
            else
            {
               _loc3_ = "技能" + GS.a4;
               this.changeActionByNameAndUpdate(param1,_loc3_);
               this.jinengFourFlag = GM.frameTime;
               this.jinengFiveFlag = true;
               (this.jaAtionObj[_loc3_] as CAction).setccd(0);
            }
            return;
         }
         if(GM.ckey.isKey("跳"))
         ...
         if(GM.ckey.isKey("枪攻"))
         {
            ...
            {
               if(param1.currentFrameName != "枪跳击" || param1.currentFrameName == "枪跳击" && curAction.useKeyDaDuan() == ActionConstant.KeyDaDuanYB)
               {
                  _loc3_ = "枪跳击";
                  this.changeActionByNameAndUpdate(param1,_loc3_);
                  return;
         ...
         if(Boolean(GM.ckey.isKey("剑攻")) && param1.cmp >= GS.a18 * GS.a10)
         {
            if(param1.skyType == 0)
            {
            ...
            {
               if(param1.currentFrameName != "剑跳击" || param1.currentFrameName == "剑跳击" && curAction.useKeyDaDuan() == ActionConstant.KeyDaDuanYB)
               {
                  _loc3_ = "剑跳击";
      ...
      private function jaAtionObjInit() : void
      {
         ...
         var _loc2_:Array = ["枪跳击","枪攻击","跳攻1","跳攻2","剑攻1","剑攻2","剑攻3","剑攻4","技能1","技能2","技能3","技能4","技能5"];
         var _loc3_:Object = {};
         for each(_loc4_ in _loc1_)
         {
            this.jaAtionObj[_loc4_] = RoleActionManger.getJiJiaActionByName("" + "银翼战神" + _loc4_ + 1);
         }
         for each(_loc5_ in _loc2_)
         {
            this.jaAtionObj[_loc5_] = RoleActionManger.getJiJiaActionByName("" + "银翼战神" + _loc5_ + 1);
         }
      }
