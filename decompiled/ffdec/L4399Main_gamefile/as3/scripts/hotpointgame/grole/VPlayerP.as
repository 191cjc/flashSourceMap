package hotpointgame.grole
{
   ...
   public class VPlayerP extends Vplayer
   {
      ...
      public function VPlayerP(param1:MovieClip)
      {
         ...
         if(this.yaodaiMcS == "")
         {
            this.yaodaiMcS = "e_yaodaichushi";
         }
         this.sZyifuaAMcS = FlowInterface.getEquipMcName(GS.a8);
         if(this.sZyifuaAMcS == "")
         {
            this.sZyifuaAMcS = "WuqLMH_null";
            this.sZyifuaBMcS = "WuqLMH_null";
         }
         else
         {
         ...
         {
            this.sZxuanguangAMcS = "WuqLMH_null";
            this.sZxuanguangBMcS = "WuqLMH_null";
         }
         else
         {
         ...
         {
            this.sZjiangbanAMcS = "WuqLMH_null";
            this.sZjiangbanBMcS = "WuqLMH_null";
         }
         else
         {
         ...
         var _loc11_:Class = LoaderManager.getSwfClass("e_jineng") as Class;
         this.jinengMc = new _loc11_() as MovieClip;
         var _loc12_:Class = LoaderManager.getSwfClass("e_zhuangtai") as Class;
      ...
      private function allshowAndH() : void
      {
         ...
         if(this.sZyifuaAMcS == "WuqLMH_null" || _loc1_[8] == false)
         {
         ...
         if(this.sZwuqiMcS == "WuqLMH_null" || _loc1_[11] == false)
         {
      ...
      override public function typeShowAndH(param1:int, param2:Boolean) : void
      {
         ...
         {
            case 8:
               if(this.sZyifuaAMcS == "WuqLMH_null" || param2 == false)
               {
                  this.kaijiaMcP.visible = true;
                  this.yaodaiMcP.visible = true;
                  this.huwanMcP.visible = true;
            ...
            case 11:
               ...
               else if(this.sZwuqiMcS == "WuqLMH_null" || param2 == false)
               {
                  this.sZwuqiMcP.visible = false;
                  this.baseWeaponMcP.visible = true;
               }
      ...
      override public function changeByEquipSlot(param1:int, param2:String) : void
      {
         ...
         if(param2 == "")
         {
            ...
            {
               case GS.a0:
                  param2 = "WuqiB_xinshouqiang";
                  break;
               case GS.a1:
                  param2 = "e_kaijiachushi";
                  break;
               case GS.a2:
                  param2 = "e_yaodaichushi";
                  break;
               case GS.a5:
                  param2 = "e_huwanchushi";
                  break;
               case GS.a8:
                  param2 = "WuqLMH_null";
                  break;
            ...
            case GS.a8:
               if(this.sZyifuaAMcS != param2)
               {
                  if(LoaderManager.isLoadedByMcname(param2))
                  {
                     ...
                     this.sZyifuaAMcP.addChild(this.sZyifuaAMc);
                     if(this.sZyifuaAMcS == "WuqLMH_null")
                     {
            ...
            case GS.a10:
               if(this.sZjiangbanAMcS != param2)
               {
                  if(LoaderManager.isLoadedByMcname(param2))
                  {
                     ...
                     this.sZjiangbanAMcP.addChild(this.sZjiangbanAMc);
                     if(this.sZjiangbanAMcS == "WuqLMH_null")
                     {
            ...
            case GS.a12:
               if(this.sZxuanguangAMcS != param2)
               {
                  if(LoaderManager.isLoadedByMcname(param2))
                  {
                     ...
                     this.sZxuanguangAMcP.addChild(this.sZxuanguangAMc);
                     if(this.sZxuanguangAMcS == "WuqLMH_null")
                     {
      ...
      override public function lostMapWeapon() : void
      {
         this.mapGunShowAndH();
         this.mapWeaponMcP.visible = false;
         this.changeMapWeaponMc("WuqLMH_null");
      }
      ...
      override public function getBullet(param1:String) : MovieClip
      {
         ...
         if(param1 == "abullet" || param1 == "abulletb")
         {
            ...
            else if(this.baseWeaponMcS == "WuqiB_sdszq")
            {
               _loc2_.gotoAndStop(41);
            }
            else if(this.baseWeaponMcS == "WuqiB_hyemqiang")
            {
               _loc2_.gotoAndStop(46);
            }
            else if(this.baseWeaponMcS == "WuqiB_shijiebeiqiang")
            {
               _loc2_.gotoAndStop(51);
            }
            else
            {
