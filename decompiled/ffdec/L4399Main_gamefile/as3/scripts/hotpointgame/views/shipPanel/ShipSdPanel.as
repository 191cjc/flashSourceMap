package hotpointgame.views.shipPanel
{
   ...
   public class ShipSdPanel extends MovieClip
   {
      
      private static var _instance:ShipSdPanel;
      ...
      public static function loadSpGtOver() : void
      {
         ...
         if(cbx == -1)
         {
            _instance = new ShipSdPanel();
            _loc1_ = LoaderManager.getSwfClass("ShipGtMc") as Class;
