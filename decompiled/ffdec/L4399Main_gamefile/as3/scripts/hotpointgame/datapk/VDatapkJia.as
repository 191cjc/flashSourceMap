package hotpointgame.datapk
{
   ...
   public class VDatapkJia extends VDatapkI
   {
      
      private var skinMc:MovieClip;
      
      public function VDatapkJia(param1:MovieClip, param2:String, param3:String, param4:int, param5:String = "")
      {
         super();
         ya = 136;
         yb = -86;
         this.skinMc = param1;
         iniTitleName(param2,param3,param4,param5);
