package hotpointgame.datapk
{
   ...
   public class VDatapkMan extends VDatapkI
   {
      ...
      public function VDatapkMan(param1:MovieClip, param2:Array, param3:String, param4:int, param5:String = "")
      {
         super();
         ...
         var _loc15_:Class = LoaderManager.getSwfClass("e_jineng") as Class;
         this.jinengMc = new _loc15_() as MovieClip;
         var _loc16_:Class = LoaderManager.getSwfClass("e_zhuangtai") as Class;
